...
{
private:
 MarketState m_market; StateReconciler m_reconciler; DebugPanel m_panel; PendingTrailingObserver m_trailing; OperationalState m_operational_state; bool m_initialized; int m_magic;
